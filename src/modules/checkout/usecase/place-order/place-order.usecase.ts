...
import PaymentFacadeInteface from "../../../payment/facade/facade.interface";
...
export default class PlaceOrderUsecase implements UseCaseInterface {
  ...
  private _paymentFacade: PaymentFacadeInteface;

  constructor(clientFacade: ClientAdmFacadeInterface, productFacade: ProductAdmFacadeInterface, catalogFacade: StoreCatalogFacadeInterface, repository: CheckoutGateway, invoiceFacade: InvoiceFacadeInterface, paymentFacade: PaymentFacadeInteface) {
  ...
  async execute(input: PlaceOrderInputDto): Promise<PlaceOrderOutputDto> {
    ...
    return {
      id: order.id.id,
      invoiceId: paymentStatus === "APPROVED" ? invoice.id : null,
      status: order.status,
      total: order.total,
